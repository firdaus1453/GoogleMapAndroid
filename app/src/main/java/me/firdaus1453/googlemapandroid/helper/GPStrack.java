...
public class GPStrack extends Service implements LocationListener {
    ...
    private Location getLocation() {
        try {
            ...
            // getting me.firdaus1453.googlemapandroid.network status
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                canGetLocation = true;
                // get lat/lng by me.firdaus1453.googlemapandroid.network
                if (isNetworkEnabled) {
                    ...
                    if (checkPermission(context)) {
                        locationManager.requestLocationUpdates(
                                ...
                                MIN_DISTANCE, this);
                        Log.d("me/firdaus1453/googlemapandroid/network", "me.firdaus1453.googlemapandroid.network enabled");
